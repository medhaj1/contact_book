    ...
    <div className="flex items-center justify-center min-h-screen px-8 bg-gradient-to-r from-blue-100 to-white">
      <div className="text-center max-w-3xl text-gray-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-12 max-w-4xl mx-auto">
          <div className="bg-white rounded-xl p-6 text-center shadow-md border border-blue-100 scale-100 hover:scale-105 transition-transform duration-300">
            <div className="text-3xl mb-3">📱</div>
            <h3 className="text-xl font-semibold text-blue-800 mb-2">Easy Management</h3>
          ...
          <div className="bg-white rounded-xl p-6 text-center shadow-md border border-blue-100 scale-100 hover:scale-105 transition-transform duration-300">
            <div className="text-3xl mb-3">🔍</div>
            <h3 className="text-xl font-semibold text-blue-800 mb-2">Smart Search</h3>
            <p className="text-sm text-gray-600">
          ...
          <div className="bg-white rounded-xl p-6 text-center shadow-md border border-blue-100 scale-100 hover:scale-105 transition-transform duration-300">
            <div className="text-3xl mb-3">📊</div>
            <h3 className="text-xl font-semibold text-blue-800 mb-2">Categories</h3>
            <p className="text-sm text-gray-600">
