...
import { User, LogOut, Download, Settings, Users, MessageSquare } from 'lucide-react';
...
const HeaderSection = ({
  ...
  const exportDropdownRef = useOutsideClick(
        ...
        <div className="flex gap-4">
          <span
            className={`cursor-pointer transition-all duration-200 transform ${
              activeTab === "contacts"
                ? "scale-105 text-2xl font-semibold text-slate-900 dark:text-gray-100"
                : "scale-100 text-lg font-medium text-slate-400 dark:text-[#8b949e] hover:text-slate-500 dark:hover:text-gray-300/80"
